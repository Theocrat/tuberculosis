...
# PARAMETERS:
# ----------
gamma_coeff = 15    # --> gamma-coeff is multiplied by 0.1, then added to 1. The result is multiplied by (1/n_features) to obtain the gamma.
C100 = 250           # --> C100 == 100 times the value of the C parameter. Should be integer.
