...
# PARAMETERS:
# ----------
C100 = int( argv[1] )                # --> num_est == Number of Estimators.
...
for val_num in range(num_sets):
    ...
    clf = SVC(kernel = 'linear', C = 0.9+(C100/100.0), gamma = rel_gamma/10.0, random_state = seed)
...
#print # newline.
print str( C100/10.0 ) + ',' + str( rel_gamma/10.0 ) + ',' + str( round(overall, 3) )
