...
class extract_features:
    ...
    def prepare(case, option):
        ...
        prefix  = '/home/rajarshi/Documents/MTP/project-datasets/Feature_Vectors/'
    ...
    def fetch_train():
        ...
        dfname  = '/home/rajarshi/Documents/MTP/project-datasets/Feature_Vectors/mc-cxr/train-data.csv'
        f = open(dfname, 'r')
        table = pd.read_csv(f)
        f.close()
    ...
    def fetch_test():
        ...
        dfname  = '/home/rajarshi/Documents/MTP/project-datasets/Feature_Vectors/mc-cxr/test-data.csv'
        f = open(dfname, 'r')
        table = pd.read_csv(f)
        f.close()
