...
# PARAMETERS:
# ----------
gamma_coeff = 6    # --> gamma-coeff is multiplied by 0.1, then added to 1. The result is multiplied by (1/n_features) to obtain the gamma.
C100 = 100           # --> C100 == 100 times the value of the C parameter. Should be integer.
...
for val_num in range(11):
    ...
    gamma_coeff *= 0.1
    gamma_used = (1.0 / 23) * (1 + gamma_coeff)
    clf = SVC(kernel='rbf', random_state=seed, C = float(C100)/100, gamma = gamma_used)
