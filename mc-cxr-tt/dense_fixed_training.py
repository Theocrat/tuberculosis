...
class myModel(torch.nn.Module):
    def __init__(self):
        ...
        self.layer_inp = nn.Linear(105, 23,  bias=True)
        self.layer_hid = nn.Linear(23, 9,  bias=True)
        self.layer_out = nn.Linear(9, 2, bias=True)
...
print('Accuracy:', float(correct)/88)
